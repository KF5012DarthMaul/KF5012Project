...
public abstract class AbstractTimeField extends JPanel {
    ...
    public void setEnabled(boolean enabled) {
    	this.getHourField().setEnabled(enabled);
    	this.getMinuteField().setEnabled(enabled);
    }
    ...
    public class TimeFocusTraversalPolicy extends FocusTraversalPolicy {
