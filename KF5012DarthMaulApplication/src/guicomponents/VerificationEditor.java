...
public class VerificationEditor extends ObjectEditor<Verification> {
	...
	private JComboBox<TaskPriority> cmbStandardPriority;
	...
	public VerificationEditor() {
		...
		gbc_lblStandardPriority.insets = new Insets(0, 0, 5, 5);
		...
		gbc_lblAllocationConstraint.insets = new Insets(0, 0, 5, 5);
		...
		gbc_cmbAllocationConstraint.gridx = 2;
		...
		gbc_lblStandardDeadline.insets = new Insets(0, 0, 0, 5);
		...
		gbc_durStandardDeadline.insets = new Insets(0, 5, 0, 0);
